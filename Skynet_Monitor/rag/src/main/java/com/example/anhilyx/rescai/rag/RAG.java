...
public class RAG {
    ...
    public static void init(Context context, RAGCallback callback, boolean forceReinstall) {
        ...
        if (tokenizer != null && embeddingEngine != null && objectBox != null && !forceReinstall) {
     ...
     */
    public static void createRAG(InputStream pdfIS, String fileName, RAGCallback callback) {
        ...
        try {
            ...
            for (int i = 0; i < chunks.length; i++) {
                ...
                objectBox.putItem(chunks[i], embedding, fileName);
    ...
    /**
     * Get all unique file names currently indexed in the RAG system.
     * @return A list of file names.
     */
    public static java.util.List<String> getIndexedFiles() {
        if (objectBox == null) return new java.util.ArrayList<>();
        return objectBox.getAllFiles();
    }

    /**
     * Remove all entries associated with a specific file from the RAG index.
     * @param fileName The name of the file to remove.
     */
    public static void removeFile(String fileName) {
        if (objectBox != null) {
            objectBox.removeFile(fileName);
        }
    }
     ...
     * @return A string containing info like total number of chunks.
     */
    public static String getRagInfo() {
        if (objectBox == null) return "RAG not initialized";
        long count = objectBox.countItems();
