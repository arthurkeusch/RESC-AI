...
public class Config {
    ...
    public static int N_RESULTS = 5;  // The number of results to return for a query.

    public static int N_TOKENS = 128;  // The maximum number of tokens.
    public static int CHUNK_SIZE = 1024;  // The minimum number of characters in each chunk.
}
